...
| 04 | lpc | `mlow` | mlow-lpc.md | codec/mlow/decode-pipeline | `mlow/smpl_lpc.rs` | `lsf_vectors.json` | planned |
| 05 | lsf | `mlow` | mlow-lsf.md | codec/mlow/decode-pipeline | `mlow/smpl_decode.rs` | `lsf_vectors.json` | planned |
